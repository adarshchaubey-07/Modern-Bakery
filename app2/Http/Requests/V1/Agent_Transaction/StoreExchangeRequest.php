 ...
 public function rules(): array
{
    return [
        ...
        'invoices.*.uom_id' => 'required|integer|exists:item_uoms,id',
        ...
        'invoices.*.return_type' => 'required|string',
        'invoices.*.region' => 'required|string',

        'returns' => 'required|array|min:1',
        'returns.*.item_id' => 'required|integer|exists:items,id',
        'returns.*.uom_id' => 'required|integer|exists:item_uoms,id',
