    ...
    public function collection()
    {
        ...
        foreach ($headers as $header) {
            $rows[] = [
                ...
                'Warehouse Email'           => $header->warehouse->warehouse_email ?? null,
                'Warehouse Town/Village'    => $header->warehouse->town_village ?? null,
                'Warehouse Street'          => $header->warehouse->street ?? null,
