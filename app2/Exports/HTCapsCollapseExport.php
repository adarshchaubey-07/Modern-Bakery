...
class HTCapsCollapseExport implements FromCollection, WithHeadings, ShouldAutoSize, WithEvents, WithStyles
{
    ...
    public function collection()
    {
        ...
        foreach ($headers as $header) {
            ...
            $rows[] = [
                ...
                'Warehouse Email'       => (string) ($header->warehouse->warehouse_email ?? ''),
                ...
                'Contact No'            => (string) $header->contact_no,
            ...
            $details = HtCapsDetail::with(['item', 'itemuom'])
