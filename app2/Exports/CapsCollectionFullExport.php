...
class CapsCollectionFullExport implements FromCollection, WithHeadings, ShouldAutoSize, WithEvents
{
    public function collection()
    {
        $rows = [];

        $headers = CapsCollectionHeader::with(['warehouse', 'route', 'salesman'])->get();
