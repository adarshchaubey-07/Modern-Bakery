...
class InvoiceService
{
    ...
    //         }
    //         DB::commit();
    //         app(\App\Services\V1\Loyality_Management\LoyalityPointService::class)->createFromInvoice($header);

    //         app(\App\Services\V1\Settings\Web\TierService::class)->calculateCustomerTier($header->customer_id);
