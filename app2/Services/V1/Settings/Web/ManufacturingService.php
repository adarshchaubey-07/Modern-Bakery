...
class ManufacturingService
{
    ...
    public function createBank(array $data): Manufacturing
    {
        return DB::transaction(function () use ($data) {
            return Manufacturing::create($data);
        });
    }
    ...
    public function getByUuid(string $uuid): ?Manufacturing
{
    return Manufacturing::where('uuid', $uuid)->first();
}


public function updateBankByUuid(string $uuid, array $data): ?Manufacturing
{
    $bank = Manufacturing::where('uuid', $uuid)->first();
