...
<table class="address-table">
    ...
    <div class="totals">
        <table>
            ...
            <tr><td>Net Total</td><td align="right"> {{ $order->currency }} {{ number_format($order->net_amount, 2) }}</td></tr>
            <tr><td>VAT</td><td align="right">  {{ $order->currency }} {{ number_format($order->vat, 2) }}</td></tr>
