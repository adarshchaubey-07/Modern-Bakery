...
Route::prefix('settings')->group(function () {
    Route::middleware('auth:api')->group(function () {
        ...
        Route::prefix('warehouse-stocks')->group(function () {
            ...
            Route::get('/{warehouseId}/low-items', [WarehouseStockController::class, 'getHighQuantityItems']);
...
Route::prefix('agent_transaction')->group(function () {
    Route::middleware('auth:api')->group(function () {
        Route::prefix('load')->group(function () {
            Route::get('exportcollapse', [LoadHeaderController::class, 'exportCollapseLoad']);
            ...
            Route::get('export', [LoadHeaderController::class, 'exportLoadHeader']);
            Route::get('exportall', [LoadHeaderController::class, 'exportLoad']);
