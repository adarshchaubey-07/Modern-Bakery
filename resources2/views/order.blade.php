...
<table class="address-table">
    <tr>
        ...
        <td class="address-cell">
            ...
            Phone: {{ $order->customer->contact_no  ?? ''}}<br>
        ...
        <table>
            ...
            @foreach($orderDetails as $i => $item)
                <tr>
                    ...
                    <td>{{ number_format(round($item->net_total), 2) }}</td>
    ...
    <div class="totals">
        <table>
            ...
            <tr><td>Net Total</td><td align="right"> {{$order->currency}} {{ number_format((int)$order->net_amount, 2) }}</td></tr>
    ...
    <!-- NOTE -->
    <div class="note">
        <strong>Note:</strong> {{ $order->comment ?? 'No notes added.' }}
    </div>

    <!-- PAYMENT -->
    <!-- <div class="payment">
        Payment Type: {{ $order->payment_type ?? 'Not Specified' }}
    </div> -->
