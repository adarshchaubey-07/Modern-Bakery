...
use App\Imports\AgentCustomerImport;
...
class AgentCustomerController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        foreach (
            ...
            if (!empty($filters[$key])) {
                $filters[$key] = array_map('intval', explode(',', $filters[$key]));
            }
        }
    ...
    public function update(Request $request, string $uuid)
    {
        $validated = $request->validate([ 
            ...
            'owner_name'=>'nullable|string|max:25',
            ...
            'subcategory_id' => 'nullable|exists:customer_sub_categories,id',
            'latitude'=>'nullable|string',
            'longitude'=>'nullable|string',
            'qr_code'=>'nullable|string',
            'status'=>'nullable|integer|in:0,1',
            'enable_promotion'=>'nullable|integer|in:0,1',
            'account_group' => 'nullable|exists:account_grp,id',
            'is_driver' => 'nullable|integer|in:0,1',
            'tin_no' => 'nullable',
...
// }
    ...
    public function importAgentCustomers(Request $request)
{
    $request->validate([
        'file' => 'required|mimes:xlsx,xls,csv'
    ]);

    Excel::import(new AgentCustomerImport, $request->file('file'));
