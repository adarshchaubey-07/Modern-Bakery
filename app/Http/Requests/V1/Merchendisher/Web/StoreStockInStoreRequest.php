...
//             'nullable',
//             'string',
//             Rule::unique('stock_in_store', 'code')->ignore($this->route('uuid'), 'uuid'),
//         ],
...
//         'assign_customers'   => 'required|array|min:1',
//         'assign_customers.*' => 'integer',

//         'assign_inventory' => 'required|array|min:1',
//         'assign_inventory.*.item_id'  => 'required|exists:items,id',
//         'assign_inventory.*.item_uom' => 'required|exists:item_uoms,id',
//         'assign_inventory.*.capacity' => 'required|integer|min:1',
//     ];
// }