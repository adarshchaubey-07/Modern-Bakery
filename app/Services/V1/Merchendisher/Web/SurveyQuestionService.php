...
public function createMultiple(array $data)
{
    ...
    foreach ($data['questions'] as $questionData) {
        ...
        if (!empty($questionData['question_based_selected'])) {
            if (is_array($questionData['question_based_selected'])) {
                $questionData['question_based_selected'] =
                    implode(',', $questionData['question_based_selected']);
            }
        }
        $createdQuestions[] = SurveyQuestion::create([
            'survey_id' => $data['survey_id'],
            'question' => $questionData['question'],
            'question_type' => strtolower($questionData['question_type']),
            'question_based_selected' => $questionData['question_based_selected'] ?? null,
        ]);
    }
